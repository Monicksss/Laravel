...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php endif; ?>
                <form method="POST" action="<?php echo e(url('/register-student')); ?>" name="registration" onsubmit="return valid();">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <!-- Registration Number -->
    ...
    <script>
        function checkAvailability() {
            $("#loaderIcon").show();
            $.ajax({
                url: "<?php echo e(url('/check-availability')); ?>",
                data: {
                    emailid: $("#email").val()
                },
                type: "POST",
...
<?php /**PATH C:\Users\MANO\Desktop\task\hostelms\resources\views/register-student.blade.php ENDPATH**/ ?>