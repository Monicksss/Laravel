                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" value="<?php echo e($user->username); ?>" disabled class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="emailid" id="emailid" value="<?php echo e($user->email); ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="<?php echo e($user->reg_date); ?>" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\MANO\Desktop\task\hostelms\resources\views/profile.blade.php ENDPATH**/ ?>